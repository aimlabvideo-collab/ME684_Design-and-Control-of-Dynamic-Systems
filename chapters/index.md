...
Detailed notes for each topic. Use the sidebar (or the list below) to navigate.
...
7. [Frequency Response (Bode, Nyquist)](ch7-frequency-response.md)
8. [State-Space Modeling & Design](ch8-state-space.md)
9. [Controller Design (PID, State Feedback)](ch9-controller-design.md)
